...
class Docx:
    def __init__(self, way_list: list, date: str, doc_num: int, organization: str):
        ...
        self.doc = docx.Document(
            'C:\\Users\\Ryzhk\\PycharmProjects\\Грузоперевозки\\Грузоперевозки\\Шаблон_dox.docx')
    ...
    def docx_writer(self):
        ...
        self.doc.save(f'C:\\Users\\Ryzhk\\Desktop\\Грузоперевозки\\' + str(self.doc_num) + '      '
                      + self.date + '         ' + self.street_1 + ' - ' + self.street_2 + ' ' + '.docx')
...
class Exel:
    ...
    def __init__(self, list_with_str: list, act_val: int, document_number: int, organization: str, money_at_hour: int):
        ...
        self.organization = organization
        self.wb = openpyxl.load_workbook('/CargoTransportation/Грузоперевозки/Шаблон_exel.xlsx')
    ...
    def exel_writer(self):
        ...
        os.chdir(f'C:\\Users\\Ryzhk\\Desktop\\Грузоперевозки')
